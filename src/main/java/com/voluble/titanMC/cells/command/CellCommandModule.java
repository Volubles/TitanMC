...
public final class CellCommandModule implements CommandModule {
	...
	private int root(MichelleCommandContext c)throws CommandSyntaxException{c.playerExecutor().sendMessage("Usage: /cell <create|delete|list|info|reset|sign|member>");return CommandTree.ok();}
